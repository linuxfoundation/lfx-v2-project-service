...
// BuildListProjectLinksRequest instantiates a HTTP request object with method
// and path set to call the "project-service" service "list-project-links"
// endpoint
func (c *Client) BuildListProjectLinksRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		uid string
	)
	{
		p, ok := v.(*projectservice.ListProjectLinksPayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("project-service", "list-project-links", "*projectservice.ListProjectLinksPayload", v)
		}
		uid = p.UID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: ListProjectLinksProjectServicePath(uid)}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("project-service", "list-project-links", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeListProjectLinksRequest returns an encoder for requests sent to the
// project-service list-project-links server.
func EncodeListProjectLinksRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*projectservice.ListProjectLinksPayload)
		if !ok {
			return goahttp.ErrInvalidType("project-service", "list-project-links", "*projectservice.ListProjectLinksPayload", v)
		}
		if p.BearerToken != nil {
			head := *p.BearerToken
			if !strings.Contains(head, " ") {
...
// DecodeListProjectLinksResponse returns a decoder for responses returned by
// the project-service list-project-links endpoint. restoreBody controls
// whether the response body should be restored after having been read.
// DecodeListProjectLinksResponse may return the following errors:
//   - "InternalServerError" (type *projectservice.InternalServerError): http.StatusInternalServerError
//   - "NotFound" (type *projectservice.NotFoundError): http.StatusNotFound
//   - "ServiceUnavailable" (type *projectservice.ServiceUnavailableError): http.StatusServiceUnavailable
//   - error: internal error
func DecodeListProjectLinksResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("project-service", "list-project-links", err)
			}
			err = ValidateListProjectLinksResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-links", err)
			}
			res := NewListProjectLinksResultOK(&body)
			return res, nil
		case http.StatusInternalServerError:
			var (
			...
			err = ValidateListProjectLinksInternalServerErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-links", err)
			}
			return nil, NewListProjectLinksInternalServerError(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateListProjectLinksNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-links", err)
			}
			return nil, NewListProjectLinksNotFound(&body)
		case http.StatusServiceUnavailable:
			var (
			...
			err = ValidateListProjectLinksServiceUnavailableResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-links", err)
			}
			return nil, NewListProjectLinksServiceUnavailable(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("project-service", "list-project-links", resp.StatusCode, string(body))
		}
	}
}
...
// BuildListProjectFoldersRequest instantiates a HTTP request object with
// method and path set to call the "project-service" service
// "list-project-folders" endpoint
func (c *Client) BuildListProjectFoldersRequest(ctx context.Context, v any) (*http.Request, error) {
	var (
		uid string
	)
	{
		p, ok := v.(*projectservice.ListProjectFoldersPayload)
		if !ok {
			return nil, goahttp.ErrInvalidType("project-service", "list-project-folders", "*projectservice.ListProjectFoldersPayload", v)
		}
		uid = p.UID
	}
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: ListProjectFoldersProjectServicePath(uid)}
	req, err := http.NewRequest("GET", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("project-service", "list-project-folders", u.String(), err)
	}
	if ctx != nil {
		req = req.WithContext(ctx)
	}
...
// EncodeListProjectFoldersRequest returns an encoder for requests sent to the
// project-service list-project-folders server.
func EncodeListProjectFoldersRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*projectservice.ListProjectFoldersPayload)
		if !ok {
			return goahttp.ErrInvalidType("project-service", "list-project-folders", "*projectservice.ListProjectFoldersPayload", v)
		}
		if p.BearerToken != nil {
			head := *p.BearerToken
			if !strings.Contains(head, " ") {
...
// DecodeListProjectFoldersResponse returns a decoder for responses returned by
// the project-service list-project-folders endpoint. restoreBody controls
// whether the response body should be restored after having been read.
// DecodeListProjectFoldersResponse may return the following errors:
//   - "InternalServerError" (type *projectservice.InternalServerError): http.StatusInternalServerError
//   - "NotFound" (type *projectservice.NotFoundError): http.StatusNotFound
//   - "ServiceUnavailable" (type *projectservice.ServiceUnavailableError): http.StatusServiceUnavailable
//   - error: internal error
func DecodeListProjectFoldersResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
		...
		case http.StatusOK:
			...
			err = decoder(resp).Decode(&body)
			if err != nil {
				return nil, goahttp.ErrDecodingError("project-service", "list-project-folders", err)
			}
			err = ValidateListProjectFoldersResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-folders", err)
			}
			res := NewListProjectFoldersResultOK(&body)
			return res, nil
		case http.StatusInternalServerError:
			var (
			...
			err = ValidateListProjectFoldersInternalServerErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-folders", err)
			}
			return nil, NewListProjectFoldersInternalServerError(&body)
		case http.StatusNotFound:
			var (
			...
			err = ValidateListProjectFoldersNotFoundResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-folders", err)
			}
			return nil, NewListProjectFoldersNotFound(&body)
		case http.StatusServiceUnavailable:
			var (
			...
			err = ValidateListProjectFoldersServiceUnavailableResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("project-service", "list-project-folders", err)
			}
			return nil, NewListProjectFoldersServiceUnavailable(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("project-service", "list-project-folders", resp.StatusCode, string(body))
		}
	}
}
...
// unmarshalProjectLinkResponseBodyToProjectserviceProjectLink builds a value
// of type *projectservice.ProjectLink from a value of type
// *ProjectLinkResponseBody.
func unmarshalProjectLinkResponseBodyToProjectserviceProjectLink(v *ProjectLinkResponseBody) *projectservice.ProjectLink {
	res := &projectservice.ProjectLink{
		UID:               v.UID,
...
// unmarshalProjectFolderResponseBodyToProjectserviceProjectFolder builds a
// value of type *projectservice.ProjectFolder from a value of type
// *ProjectFolderResponseBody.
func unmarshalProjectFolderResponseBodyToProjectserviceProjectFolder(v *ProjectFolderResponseBody) *projectservice.ProjectFolder {
	res := &projectservice.ProjectFolder{
		UID:               v.UID,
		Name:              v.Name,
		CreatedByUsername: v.CreatedByUsername,
		CreatedAt:         v.CreatedAt,
