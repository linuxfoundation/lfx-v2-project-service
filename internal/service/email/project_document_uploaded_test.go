...
func TestRenderProjectDocumentUploaded(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantSubject: []string{"Bob", "Q4 Report", "Demo Project"},
		...
		},
		{
			...
			wantSubject: []string{"Bob", "Governance Docs", "Demo Project"},
		...
		{
			name: "link upload without uploader",
			data: ProjectDocumentUploadedData{
				RecipientName: "Carol",
			...
			wantSubject: []string{"A new document was added to", "Another Project"},
