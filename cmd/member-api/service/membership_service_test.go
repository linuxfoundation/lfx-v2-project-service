...
func TestListProjectMemberships(t *testing.T) {
	tests := []struct {
		...
		{
			name: "list memberships with search matching company name",
			payload: &membershipservice.ListProjectMembershipsPayload{
				ProjectUID: strPtr("project-uid-1"),
				PageSize:   25,
				Sort:       "newest",
		...
		{
			name: "list memberships with search matching project name",
			payload: &membershipservice.ListProjectMembershipsPayload{
				ProjectUID: strPtr("project-uid-1"),
				PageSize:   25,
				Sort:       "newest",
		...
		{
			name: "list memberships with search non-matching",
			payload: &membershipservice.ListProjectMembershipsPayload{
				ProjectUID: strPtr("project-uid-1"),
				PageSize:   25,
				Sort:       "newest",
