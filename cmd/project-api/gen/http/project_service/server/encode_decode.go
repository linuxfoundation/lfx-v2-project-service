...
func DecodeGetProjectsRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*projectservice.GetProjectsPayload, error) {
	return func(r *http.Request) (*projectservice.GetProjectsPayload, error) {
		var payload *projectservice.GetProjectsPayload
		var (
			version     *string
			bearerToken *string
			err         error
...
// project-service get-one-project endpoint.
func DecodeGetOneProjectRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*projectservice.GetOneProjectPayload, error) {
	return func(r *http.Request) (*projectservice.GetOneProjectPayload, error) {
		var payload *projectservice.GetOneProjectPayload
		var (
			id          string
			version     *string
			bearerToken *string
...
// project-service update-project endpoint.
func DecodeUpdateProjectRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*projectservice.UpdateProjectPayload, error) {
	return func(r *http.Request) (*projectservice.UpdateProjectPayload, error) {
		var payload *projectservice.UpdateProjectPayload
		var (
...
func DecodeDeleteProjectRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*projectservice.DeleteProjectPayload, error) {
	return func(r *http.Request) (*projectservice.DeleteProjectPayload, error) {
		var payload *projectservice.DeleteProjectPayload
		var (
			id          string
			version     *string
			bearerToken *string
